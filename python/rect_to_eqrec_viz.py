...
if __name__ == "__main__":
    ...
    cv2.imwrite("./output/gird.png", img)
    cv2.imshow("rectified", rect)
    cv2.imwrite("./output/grid_rect.png", rect)
    cv2.imshow("equirectangular coarse", eqrec_coarse)
    cv2.imwrite("./output/grid_eqrec_coarse.png", eqrec_coarse)
    cv2.imshow("equirectangular", eqrec)
    cv2.imwrite("./output/grid_eqrec.png", eqrec)
    cv2.waitKey(0)